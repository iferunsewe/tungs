...
f1 = Film.create name: 'La Haine', description: "When a young Arab is arrested and beaten unconscious by police, a riot erupts in the notoriously violent suburbs outside of Paris. Three of the victim's peers, Vinz (Vincent Cassel), Said (Said Taghmaoui) and Hubert (Hubert Koundé), wander aimlessly about their home turf in the aftermath of the violence as they try to come to grips with their outrage over the brutal incident. After one of the men finds a police officer's discarded weapon, their night seems poised to take a bleak turn.", release_date: DateTime.parse('November 17, 1995'), director: 'Mathieu Kassovitz'
f2 = Film.create name: 'The Intouchables', description: 'An unlikely friendship develops between a wealthy quadriplegic (François Cluzet) and his caretaker (Omar Sy), just released from prison.', release_date: DateTime.parse('September 21, 2012'), director: 'Olivier Nakache, Eric Toledano'
f3 = Film.create name: "Pan's Labyrinth", description: "In 1944 Spain young Ofelia (Ivana Baquero) and her ailing mother (Ariadna Gil) arrive at the post of her mother's new husband (Sergi López), a sadistic army officer who is trying to quell a guerrilla uprising. While exploring an ancient maze, Ofelia encounters the faun Pan, who tells her that she is a legendary lost princess and must complete three dangerous tasks in order to claim immortality.", release_date: DateTime.parse('November 24, 2006'), director: 'Guillermo del Toro'
f4 = Film.create name: 'All About My Mother', description: 'A Greek saying states that only women who have washed their eyes with tears can see clearly. This saying does not hold true for Manuela. The night a car ran over her son Esteban, Manuela cried until her eyes ran completely dry. Far from seeing clearly, the present and the future become mixed up in darkness. She begins looking for his father who has become a transvestite.', release_date: DateTime.parse('August 27, 1999'), director: 'Pedro Almodóvar'
f5 = Film.create name: 'A Clockwork Orange', description: "In an England of the future, Alex (Malcolm McDowell) and his 'Droogs' spend their nights getting high at the Korova Milkbar before embarking on 'a little of the old ultraviolence,' while jauntily warbling 'Singin' in the Rain.' After he's jailed for bludgeoning the Cat Lady to death, Alex submits to behavior modification technique to earn his freedom; he's conditioned to abhor violence. Returned to the world defenseless, Alex becomes the victim of his prior victims.", release_date: DateTime.parse('January 13, 1972'), director: 'Stanley Kubrick'
